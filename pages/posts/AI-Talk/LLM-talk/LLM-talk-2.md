...
image: https://pic.axi404.top/cover.2veo9u2fuj.jpg
categories:
    - 'AI Talk'
    - 'LLM Talk'
tags:
...
![The pipeline of PointLLM](https://pic.axi404.top/PointLLM.13lpexj2yz.png)
...
![The pipeline of EmbodiedGPT](https://pic.axi404.top/EmbodiedGPT.9kg3ykzkji.png)
...
![The pipeline of RT-Trajectory](https://pic.axi404.top/RT-Trajectory.7w6r1e9adp.png)
...
![The pipeline of Im2Flow2Act](https://pic.axi404.top/Im2Flow2Act.3nrjrkj1kx.png)
...
![Flow generation](https://pic.axi404.top/Im2Flow2Act-2.2krugon7pf.png)
...
![The pipeline of LLARVA](https://pic.axi404.top/LLARVA.175bcnc5ok.png)
...
![The instruction of LLARVA](https://pic.axi404.top/LLARVA-2.7p3j5yn4xw.png)
...
![The pipeline of ATM](https://pic.axi404.top/ATM.wihjhwxip.png)

这篇论文可以说影响力还是很拉满的，对于后续的一些轨迹 based 的工作，比如 Im2Flow2Act，明显是有很大的影响的，本身也是拿了 RSS 的满分，不过因为理解了之前的这些论文，这一篇其实很好理解。

<img src="https://pic.axi404.top/ATM-2.77dhhdlrci.png" alt="Trajectory Conditional Policy" style="display: block; margin: 0 auto; zoom: 50%;">
...
![DiT of Track2Act](https://pic.axi404.top/Track2Act.231ss3lu4u.png)
...
![Residual policy of Track2Act](https://pic.axi404.top/Track2Act-2.3k7xtupyvk.png)
...
![The pipeline of Extreme Cross-Embodiment](https://pic.axi404.top/Extreme-Cross-Embodiment.70a9lxzlxc.png)
...
![The pipeline of ECoT](https://pic.axi404.top/ECoT.45m1rgbst.png)
...
![The pipeline of VoxPoser](https://pic.axi404.top/VoxPoser.8ad6s9hl8y.png)
...
![The pipeline of MOO](https://pic.axi404.top/MOO.175bcnc5op.png)
...
![The pipeline of PIVOT](https://pic.axi404.top/PIVOT.2krugon7pm.png)
...
<img src="https://pic.axi404.top/Code-As-Policies.3k7xtupyus.png" alt="The pipeline of Code As Policies" style="display: block; margin: 0 auto; zoom: 100%;">
...
![The pipeline of MOKA](https://pic.axi404.top/MOKA.86tkujoiiw.png)
